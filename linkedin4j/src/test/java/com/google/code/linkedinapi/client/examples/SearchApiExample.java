...
public class SearchApiExample {
    ...
    private static void processCommandLine(CommandLine line, Options options) {
        if(line.hasOption(HELP_OPTION)) {
            ...
            facets.add(new Parameter<FacetType, String>(FacetType.DATE_POSTED, String.valueOf(new Date().getTime())));
    ...
    private static void printResult(People people) {
    	...
    	for (Person person : people.getPersonList()) {
    		System.out.println(person.getId() + ":" + person.getFirstName() + " " + person.getLastName() + ":" + person.getHeadline() + ":" + person.getSkills());
    	}
	}
