...
public class JobsApiExample {
    ...
    private static void processCommandLine(CommandLine line, Options options) {
        if(line.hasOption(HELP_OPTION)) {
    		...
    		final LinkedInApiClient linkedInClient = factory.createLinkedInApiClient(accessTokenValue, tokenSecretValue);
    		Map<SearchParameter, String> searchParameters = new HashMap<SearchParameter, String>();
    		searchParameters.put(SearchParameter.COUNTRY_CODE, "fr");
    		
            List<Parameter<FacetType, String>> facets = new ArrayList<Parameter<FacetType,String>>();
            facets.add(new Parameter<FacetType, String>(FacetType.DATE_POSTED, "1"));
            facets.add(new Parameter<FacetType, String>(FacetType.DATE_POSTED, "2"));
            facets.add(new Parameter<FacetType, String>(FacetType.INDUSTRY, IndustryCodes.Computer_Software));
            facets.add(new Parameter<FacetType, String>(FacetType.INDUSTRY, IndustryCodes.Computer_and_Network_Security));
            facets.add(new Parameter<FacetType, String>(FacetType.INDUSTRY, IndustryCodes.Computer_Hardware));
    		
    		Jobs jobs = linkedInClient.searchJobs(searchParameters,EnumSet.allOf(JobField.class), facets);
